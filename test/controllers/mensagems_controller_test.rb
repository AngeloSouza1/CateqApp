...
class MensagemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mensagem" do
    assert_difference("Mensagem.count") do
      post mensagems_url, params: { mensagem: { content: @mensagem.content, user_id: @mensagem.user_id } }
    end
  ...
  test "should update mensagem" do
    patch mensagem_url(@mensagem), params: { mensagem: { content: @mensagem.content, user_id: @mensagem.user_id } }
