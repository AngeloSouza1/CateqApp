...
class PostagemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create postagem" do
    assert_difference("Postagem.count") do
      post postagems_url, params: { postagem: { content: @postagem.content, title: @postagem.title, user_id: @postagem.user_id } }
    end
  ...
  test "should update postagem" do
    patch postagem_url(@postagem), params: { postagem: { content: @postagem.content, title: @postagem.title, user_id: @postagem.user_id } }
